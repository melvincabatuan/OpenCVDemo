package com.cabatuan.cobalt.opencvdemo;
// Note: All credit goes to OpenCV Image Manipulation Demo
...
public class Main extends Activity implements CvCameraViewListener2 {
    ...
    public Mat onCameraFrame(CvCameraViewFrame inputFrame) {
        ...
        switch (Main.viewMode) {
            case Main.VIEW_MODE_RGBA:
                break;

            case Main.VIEW_MODE_HIST:
                Mat hist = new Mat();
            ...
            case Main.VIEW_MODE_SEPIA:
                rgbaInnerWindow = rgba.submat(top, top + height, left, left + width);
                Core.transform(rgbaInnerWindow, rgbaInnerWindow, mSepiaKernel);
                rgbaInnerWindow.release();
                break;

            case Main.VIEW_MODE_ZOOM:
